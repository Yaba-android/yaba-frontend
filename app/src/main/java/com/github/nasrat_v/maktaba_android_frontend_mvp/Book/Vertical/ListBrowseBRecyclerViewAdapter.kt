...
import com.github.nasrat_v.maktaba_android_frontend_mvp.Book.Horizontal.BrowseBRecyclerViewAdapter
import com.github.nasrat_v.maktaba_android_frontend_mvp.ICallback.ITabFragmentClickCallback
import com.github.nasrat_v.maktaba_android_frontend_mvp.R

class ListBrowseBRecyclerViewAdapter(private var context: Context, private var list: ArrayList<ListBModel>,
                                     private var mTabFragmentClickCallback: ITabFragmentClickCallback)
    : RecyclerView.Adapter<ListBrowseBRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val horizontalRecyclerViewAdapter = BrowseBRecyclerViewAdapter(context, model.bookHorizontalModels)
        ...
        holder.horizontalRecyclerView.addItemDecoration(
            LeftOffsetDecoration(context, R.dimen.left_book_horizontal_recycler_view)
        )
    }

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var horizontalRecyclerView = itemView.findViewById<RecyclerView>(R.id.horizontal_recyclerview_browse)!!
    }
}
