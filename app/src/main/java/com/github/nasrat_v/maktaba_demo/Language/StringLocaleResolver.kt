package com.github.nasrat_v.maktaba_demo.Language
...
class StringLocaleResolver(private var languageCode: String) {
    ...
    companion object {
        ...
        val ARABIC_STRINGS = mapOf(
            R.string.results to R.string.results_arabic,
            R.string.find_the_books_you_love to R.string.find_the_books_you_love_arabic,
            R.string.search_by to R.string.search_by_arabic,
            ...
            R.string.opening to R.string.opening_arabic,
            R.string.open_it to R.string.open_it_arabic,
